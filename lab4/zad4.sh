...
#find linux-5.11.13/ -type f -executable|wc -l
plikiZwykle=`find linux-5.11.13/ -type f -executable|wc -l`
#print $plikiZwykle
plikiSh=`find linux-5.11.13/ -type f -executable -and -name '*.sh'|wc -l`
#find linux-5.11.13/ -type f -executable -and -name '*.sh'|wc -l


printf "%s/%s" "$plikiSh" "$plikiZwykle"
